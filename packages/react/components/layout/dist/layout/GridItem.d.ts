...
declare const _GridItem: React.ForwardRefExoticComponent<{
    area?: import("@vanilla-extract/css").CSSProperties["gridArea"];
    colEnd?: import("@vanilla-extract/css").CSSProperties["gridColumnEnd"];
    colStart?: import("@vanilla-extract/css").CSSProperties["gridColumnStart"];
    colSpan?: import("@vanilla-extract/css").CSSProperties["gridColumn"];
    rowEnd?: import("@vanilla-extract/css").CSSProperties["gridRowEnd"];
    rowStart?: import("@vanilla-extract/css").CSSProperties["gridRowStart"];
    rowSpan?: import("@vanilla-extract/css").CSSProperties["gridRow"];
} & {
