...
declare const _Grid: React.ForwardRefExoticComponent<{
    autoColumns?: import("@vanilla-extract/css").CSSProperties["gridAutoColumns"];
    autoFlow?: import("@vanilla-extract/css").CSSProperties["gridAutoFlow"];
    autoRows?: import("@vanilla-extract/css").CSSProperties["gridAutoRows"];
    column?: import("@vanilla-extract/css").CSSProperties["gridColumn"];
    columnGap?: import("@vanilla-extract/css").CSSProperties["columnGap"];
    gap?: import("@vanilla-extract/css").CSSProperties["gap"];
    row?: import("@vanilla-extract/css").CSSProperties["gridRow"];
    rowGap?: import("@vanilla-extract/css").CSSProperties["rowGap"];
    templateAreas?: import("@vanilla-extract/css").CSSProperties["gridTemplateAreas"];
    templateColumns?: import("@vanilla-extract/css").CSSProperties["gridTemplateColumns"];
    templateRows?: import("@vanilla-extract/css").CSSProperties["gridTemplateRows"];
} & {
