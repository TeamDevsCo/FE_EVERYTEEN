...
declare const _Text: React.ForwardRefExoticComponent<{
    ...
    fontSize: keyof typeof import("@everyteen/themes/dist/classes/typography").text;
    align?: import("@vanilla-extract/css").CSSProperties["textAlign"];
    casing?: import("@vanilla-extract/css").CSSProperties["textTransform"];
    decoration?: import("@vanilla-extract/css").CSSProperties["textDecoration"];
