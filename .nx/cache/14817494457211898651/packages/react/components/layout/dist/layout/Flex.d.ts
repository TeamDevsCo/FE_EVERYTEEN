...
declare const _Flex: React.ForwardRefExoticComponent<{
    align?: import("@vanilla-extract/css").CSSProperties["alignItems"];
    basis?: import("@vanilla-extract/css").CSSProperties["flexBasis"];
    direction?: import("@vanilla-extract/css").CSSProperties["flexDirection"];
    grow?: import("@vanilla-extract/css").CSSProperties["flexGrow"];
    justify?: import("@vanilla-extract/css").CSSProperties["justifyContent"];
    shrink?: import("@vanilla-extract/css").CSSProperties["flexShrink"];
    wrap?: import("@vanilla-extract/css").CSSProperties["flexWrap"];
